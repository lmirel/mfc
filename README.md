...
the MFC CLIENTS are programs that receive native telemetry data and sends it to the server. clients developed so far support Assetto Corsa, Codemaster's F1 and Dirt Rally, Project Cars 2.<br>
